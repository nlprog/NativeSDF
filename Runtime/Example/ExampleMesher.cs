...
public class ExampleMesher : MonoBehaviour {
  ...
  private void Update() {
    ...
    var map = new NativeParallelHashMap<int3, int>(totalVerts, Allocator.TempJob);
  ...
  public struct BuildVertexArrayAndMap : IJob {
    ...
    [WriteOnly]
    public NativeParallelHashMap<int3, int>.ParallelWriter VertexMap;
  ...
  public struct BuildTriQueue : IJob {
    ...
    [ReadOnly]
    public NativeParallelHashMap<int3, int> VertexMap;
